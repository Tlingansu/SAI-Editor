...
namespace SAI_Editor.Forms
{
    public partial class MainForm : Form
    {
        ...
        private void GameobjectTemplateAddonWikiToolStripMenuItemCustom_Click(object sender, EventArgs e)
        {
            SAI_Editor_Manager.Instance.StartProcess("https://trinitycore.atlassian.net/wiki/spaces/tc/pages/46235672/gameobject+template+addon");
        }
        ...
        Dictionary<string, Type> searchEventHandlers = new Dictionary<string, Type>()
        {
            ...
            {"Search for aura types", typeof(SingleSelectForm<AuraTypes>)},
            {"Search for trigger cast flags", typeof(SingleSelectForm<TriggerCastFlags>)},
            ...
            {"Search for Gameobject Action IDs", typeof(SingleSelectForm<GameObjectActions>)},
        };
