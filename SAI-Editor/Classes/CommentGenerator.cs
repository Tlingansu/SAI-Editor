...
namespace SAI_Editor.Classes
{
    class CommentGenerator
    {
        ...
        public CommentGenerator()
        {
            ...
            smartActionStrings.Add(SmartAction.SMART_ACTION_CAST, "Cast '_spellNameActionParamOne_' with CastFlag: _actionParamTwo_ and TriggerFlag: _actionParamThree_ (TargetLimit: _actionParamFour_)");
            smartActionStrings.Add(SmartAction.SMART_ACTION_SUMMON_CREATURE, "Summon Creature '_creatureNameActionParamOne_' for _actionParamThree_ milliseconds _AttackInvoker_");
            smartActionStrings.Add(SmartAction.SMART_ACTION_THREAT_SINGLE_PCT, "Set Threat _actionParamOne_-_actionParamTwo_ on single target");
            smartActionStrings.Add(SmartAction.SMART_ACTION_THREAT_ALL_PCT, "Set Threat _actionParamOne_-_actionParamTwo_ on all units in threatlist");
            smartActionStrings.Add(SmartAction.SMART_ACTION_CALL_AREAEXPLOREDOREVENTHAPPENS, "Call AreaExploredOrEventHappens for Quest: '_questNameActionParamOne_'");
            smartActionStrings.Add(SmartAction.SMART_ACTION_UNUSED_16, "Set ");
            ...
            smartActionStrings.Add(SmartAction.SMART_ACTION_REMOVEAURASFROMSPELL, "Remove Aura '_spellNameActionParamOne_' Charges: _actionParamTwo_");
            ...
            smartActionStrings.Add(SmartAction.SMART_ACTION_MOVE_OFFSET, "Move Offset");
            ...
            smartActionStrings.Add(SmartAction.SMART_ACTION_RESPAWN_BY_SPAWNID, "Respawn SpawnID _actionParamTwo_ with SpawnType _actionParamOne_");
            smartActionStrings.Add(SmartAction.SMART_ACTION_INVOKER_CAST_, "Cast '_spellNameActionParamOne_' with CastFlag: _actionParamTwo_ and TriggerFlag: _actionParamThree_ (TargetLimit: _actionParamFour_)");
            ...
            smartActionStrings.Add(SmartAction.SMART_ACTION_OVERRIDE_WEATHER, "Set Zone Weather in ZoneID: _actionParamOne_ with WeatherID: _actionParamTwo_ (WeatherGrade: _actionParamThree_)");
            smartActionStrings.Add(SmartAction.SMART_ACTION_UNUSED_140, "Set ");
            smartActionStrings.Add(SmartAction.SMART_ACTION_UNUSED_141, "Set ");
            smartActionStrings.Add(SmartAction.SMART_ACTION_UNUSED_142, "Set ");
            smartActionStrings.Add(SmartAction.SMART_ACTION_UNUSED_143, "Set ");
            smartActionStrings.Add(SmartAction.SMART_ACTION_UNUSED_144, "Set ");
            smartActionStrings.Add(SmartAction.SMART_ACTION_UNUSED_145, "Set ");
            smartActionStrings.Add(SmartAction.SMART_ACTION_UNUSED_146, "Set ");
            smartActionStrings.Add(SmartAction.SMART_ACTION_UNUSED_147, "Set ");
            smartActionStrings.Add(SmartAction.SMART_ACTION_UNUSED_148, "Set ");
            smartActionStrings.Add(SmartAction.SMART_ACTION_UNUSED_149, "Set ");
            smartActionStrings.Add(SmartAction.SMART_ACTION_UNUSED_150, "Set ");
            smartActionStrings.Add(SmartAction.SMART_ACTION_UNUSED_151, "Set ");
            smartActionStrings.Add(SmartAction.SMART_ACTION_UNUSED_152, "Set ");
            smartActionStrings.Add(SmartAction.SMART_ACTION_UNUSED_153, "Set ");
            smartActionStrings.Add(SmartAction.SMART_ACTION_UNUSED_154, "Set ");
            smartActionStrings.Add(SmartAction.SMART_ACTION_UNUSED_155, "Set ");
            smartActionStrings.Add(SmartAction.SMART_ACTION_UNUSED_156, "Set ");
            smartActionStrings.Add(SmartAction.SMART_ACTION_UNUSED_157, "Set ");
            smartActionStrings.Add(SmartAction.SMART_ACTION_UNUSED_158, "Set ");
            smartActionStrings.Add(SmartAction.SMART_ACTION_UNUSED_159, "Set ");
            smartActionStrings.Add(SmartAction.SMART_ACTION_UNUSED_160, "Set ");
            smartActionStrings.Add(SmartAction.SMART_ACTION_UNUSED_161, "Set ");
            smartActionStrings.Add(SmartAction.SMART_ACTION_UNUSED_162, "Set ");
            smartActionStrings.Add(SmartAction.SMART_ACTION_UNUSED_163, "Set ");
            smartActionStrings.Add(SmartAction.SMART_ACTION_UNUSED_164, "Set ");
            smartActionStrings.Add(SmartAction.SMART_ACTION_UNUSED_165, "Set ");
            smartActionStrings.Add(SmartAction.SMART_ACTION_UNUSED_166, "Set ");
            smartActionStrings.Add(SmartAction.SMART_ACTION_UNUSED_167, "Set ");
            smartActionStrings.Add(SmartAction.SMART_ACTION_UNUSED_168, "Set ");
            smartActionStrings.Add(SmartAction.SMART_ACTION_UNUSED_169, "Set ");
            smartActionStrings.Add(SmartAction.SMART_ACTION_UNUSED_170, "Set ");
            smartActionStrings.Add(SmartAction.SMART_ACTION_UNUSED_171, "Set ");
            smartActionStrings.Add(SmartAction.SMART_ACTION_UNUSED_172, "Set ");
            smartActionStrings.Add(SmartAction.SMART_ACTION_UNUSED_173, "Set ");
            smartActionStrings.Add(SmartAction.SMART_ACTION_UNUSED_174, "Set ");
            smartActionStrings.Add(SmartAction.SMART_ACTION_UNUSED_175, "Set ");
            smartActionStrings.Add(SmartAction.SMART_ACTION_UNUSED_176, "Set ");
            smartActionStrings.Add(SmartAction.SMART_ACTION_UNUSED_177, "Set ");
            smartActionStrings.Add(SmartAction.SMART_ACTION_UNUSED_178, "Set ");
            smartActionStrings.Add(SmartAction.SMART_ACTION_UNUSED_179, "Set ");
            smartActionStrings.Add(SmartAction.SMART_ACTION_UNUSED_180, "Set ");
            smartActionStrings.Add(SmartAction.SMART_ACTION_UNUSED_181, "Set ");
            smartActionStrings.Add(SmartAction.SMART_ACTION_UNUSED_182, "Set ");
            smartActionStrings.Add(SmartAction.SMART_ACTION_UNUSED_183, "Set ");
            smartActionStrings.Add(SmartAction.SMART_ACTION_UNUSED_184, "Set ");
            smartActionStrings.Add(SmartAction.SMART_ACTION_UNUSED_185, "Set ");
            smartActionStrings.Add(SmartAction.SMART_ACTION_UNUSED_186, "Set ");
            smartActionStrings.Add(SmartAction.SMART_ACTION_UNUSED_187, "Set ");
            smartActionStrings.Add(SmartAction.SMART_ACTION_UNUSED_188, "Set ");
            smartActionStrings.Add(SmartAction.SMART_ACTION_UNUSED_189, "Set ");
            smartActionStrings.Add(SmartAction.SMART_ACTION_UNUSED_190, "Set ");
            smartActionStrings.Add(SmartAction.SMART_ACTION_UNUSED_191, "Set ");
            smartActionStrings.Add(SmartAction.SMART_ACTION_UNUSED_192, "Set ");
            smartActionStrings.Add(SmartAction.SMART_ACTION_UNUSED_193, "Set ");
            smartActionStrings.Add(SmartAction.SMART_ACTION_UNUSED_194, "Set ");
            smartActionStrings.Add(SmartAction.SMART_ACTION_UNUSED_195, "Set ");
            smartActionStrings.Add(SmartAction.SMART_ACTION_UNUSED_196, "Set ");
            ...
            smartActionStrings.Add(SmartAction.SMART_ACTION_CHECK_DUPLICATE_AND_DESPAWN, "If more than _actionParamThree_ Creature(s) with Entry: _actionParamOne_ in _actionParamTwo_ yards range, creature will despawn");
