...
namespace SAI_Editor.Classes
{
    class CommentGenerator
    {
        ...
        public CommentGenerator()
        {
            ...
            smartEventStrings.Add(SmartEvent.SMART_EVENT_QUEST_COMPLETION, "On Quest Completed");
            smartEventStrings.Add(SmartEvent.SMART_EVENT_QUEST_REWARDED, "On Quest Rewarded");
            smartEventStrings.Add(SmartEvent.SMART_EVENT_QUEST_FAIL, "On Quest Failed");
            ...
            smartEventStrings.Add(SmartEvent.SMART_EVENT_EVENT_PHASE_CHANGE, "On Dummy Effect");
            ...
            smartActionStrings.Add(SmartAction.SMART_ACTION_SET_ORIENTATION, "Set Orientation to _getTargetType_");
